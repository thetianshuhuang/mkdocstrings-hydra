...
basedir = "src/mkdocstrings_handlers/hydra/templates/material"
print("theme/")
...
See them [in the repository](https://github.com/mkdocstrings/mkdocstrings-hydra/tree/main/src/mkdocstrings_handlers/hydra/templates/).
