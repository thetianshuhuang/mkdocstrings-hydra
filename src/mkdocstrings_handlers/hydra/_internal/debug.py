...
def _get_version(dist: str = "mkdocstrings-hydra") -> str:
...
def _get_debug_info() -> _Environment:
    ...
    packages = ["mkdocstrings-hydra"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("MKDOCSTRINGS_HYDRA")]]
    return _Environment(
